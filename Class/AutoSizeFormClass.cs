...
namespace photoReader.Class
{
    class AutoSizeFormClass
    {
        ...
        public void controllInitializeSize(Window mForm)
        {
            //if (ctrl_first == 0)  
            //  ctrl_first = 1;  
            oldCtrl = new List<controlRect>();
            controlRect cR = new controlRect(); // 初始化
            cR.Left = mForm.Left;
            cR.Top = mForm.Top;
            ...
            {
                controlRect objCtrl = new controlRect(); // 初始化
                objCtrl.Left = c.Left;
                objCtrl.Top = c.Top;
        ...
        //(3.2)控件自适应大小,  
        public void controlAutoSize(Window mForm)
        {
            ...
            {//int wTop1 = this.Top;  
                ...
                float hScale = mForm.Height / (float)oldCtrl[0].Height;//.Height;  
