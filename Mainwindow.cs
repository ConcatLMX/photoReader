        ...
        private void menu1_SelectChanged(object sender, MenuSelectEventArgs e)
        {
            ...
            switch (menu)
            {
                ...
                case "statistics":
                    ...
                    break;
                case "emoji":
                    string dir = AppDomain.CurrentDomain.BaseDirectory+ "01特色表情包收集";
                    ...
                    {
                        AntdUI.Notification.error(window, "啊，好像出错了", "请检查下你的表情包资料在不在，或者在设置中验证完整性", autoClose: 3, align: TAlignFrom.TR);
                    }
                    break;
                case "p1":
